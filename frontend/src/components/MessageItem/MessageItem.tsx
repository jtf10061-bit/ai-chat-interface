import { motion } from "framer-motion"; // messageがヌルヌル出てくるもの
import { FaRobot } from "react-icons/fa"; // robotのアイコン
import { GrUserManager } from "react-icons/gr"; // userのアイコン
...
const MessageItem = ({
  ...
  const charactors: string[] = message.split("");
  return isMan ? (
